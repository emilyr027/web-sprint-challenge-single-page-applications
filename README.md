...
useRouteMatch comes in handy because it allows you to add nested routes to an app so you only need to change a single parameter in the url instead of changing the whole thing

1. How would you explain form validation to someone who has never programmed before?

It ensures what you input meets the standards of the website. It check to be sure your responses in a form have enough characters or the type of content the form is looking for. It makes sure you put an email address into the email form instead of acccidentally typing your name. 

1. In 1-2 sentences, define end to end testing.

End to end tests help confirm that all of the features of the app work when a person is using the application. It tests the input fields and makes sure everything is working as planned. 
